...
void networkInformation() {
    ...
    std::cout << "ISP: I'm doing this solo chill... (external api request required)\n";
...
void fullReport() {
    ...
    std::cout << "[ NETWORK ]\n";
    std::cout << "Local IP: " << getLocalIP() << "\n";
    std::cout << "Public IP: I'm doing this solo chill... (ipwho.is ping required invasion of privacy but fairly easy)\n";
    std::cout << "ISP: I'm doing this solo chill... (ipwho.is ping required invasion of privacy but fairly easy)\n";
